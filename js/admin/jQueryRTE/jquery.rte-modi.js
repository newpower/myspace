...
var lwRTE = function(a, b) {
    ...
    this.width = b.width || jQuery(a).width() || "100%";
...
lwRTE.prototype.enable_design_mode = function() {
    var a = this;
    var name = jQuery(a.textarea).attr("name");
    ...
    if (name) {
        a.iframe.title = name;
        //jQuery(a.iframe).before("<input type=hidden name=\""+name+"\">")
        //jQuery(a.iframe_doc).change(function(){
        //    console.log("changed")
        //})
    }

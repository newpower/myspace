				...
				for ($c = 0; $c < $strlen_var; ++$c) {
					...
					switch (true) {
						...
						case (($ord_var_c & 0xF0) == 0xE0):
							...
							// see http://www.cl.cam.ac.uk/~mgk25/unicode.html#utf-8
							$ascii .= chr($ord_var_c) . $var{$c+1} . $var{$c+2};
							$c+=2;
							break;
						...
						case (($ord_var_c & 0xF8) == 0xF0):
							...
							// see http://www.cl.cam.ac.uk/~mgk25/unicode.html#utf-8
							$ascii .= chr($ord_var_c) . $var{$c+1} . $var{$c+2} . $var{$c+3};
							$c+=3;
							break;
						...
						case (($ord_var_c & 0xFC) == 0xF8):
							...
							// see http://www.cl.cam.ac.uk/~mgk25/unicode.html#utf-8
							$ascii .= chr($ord_var_c) . $var{$c+1} . $var{$c+2} . $var{$c+3} . $var{$c+4};
							$c+=4;
							break;
						...
						case (($ord_var_c & 0xFE) == 0xFC):
							...
							// see http://www.cl.cam.ac.uk/~mgk25/unicode.html#utf-8
							$ascii .= chr($ord_var_c) . $var{$c+1} . $var{$c+2} . $var{$c+3} . $var{$c+4} . $var{$c+5};
							$c+=5;
							break;
					}
				}
			...
			case 'array':
				...
				*/
				...
				if (is_array($var) && count($var) && (array_keys($var) !== range(0, sizeof($var) - 1))) {
					return '{' .
						   join(',', array_map(array('CJSONUTF8', 'nameValue'),
											   array_keys($var),
											   array_values($var)))
						   . '}';
				}
				...
				return '[' . join(',', array_map(array('CJSONUTF8', 'encode'), $var)) . ']';

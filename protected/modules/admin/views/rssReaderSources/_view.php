<div class="view">
<?php echo CHtml::image($data->link_image); ?>
	<b><?php echo CHtml::encode($data->getAttributeLabel('id')); ?>:</b>
	<?php echo CHtml::link(CHtml::encode($data->id)." - ", array('view', 'id'=>$data->id)); ?>
	<?php echo CHtml::link("Изменить Parse part ", array('updateParse', 'id'=>$data->id)); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('parse_active')); ?>:</b>
	<?php echo CHtml::encode($data->parse_active); ?>
	<br />
